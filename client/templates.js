(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">Beer Tracker</a></div><ul class="nav navbar-nav"><li><a href="/">home</a></li><li><a href="/collections">collection demo</a></li><li><a href="/info">more info</a></li><li><a href="/beers">beers</a></li></ul></div></nav><div class="container"><main role="page-container"></main></div></body>';
    };
    ...
    // includes/beer.jade compiled template
    templatizer["includes"]["beer"] = function tmpl_includes_beer() {
        return '<li class="beer list-group-item"><img role="avatar" width="40" height="40"/><a role="name"></a><span class="btn-group pull-right"> <a role="action-edit" class="btn btn-default">edit </a><a href="#" role="action-delete" class="btn btn-danger">delete</a></span></li>';
    };
    ...
    // pages/beerAdd.jade compiled template
    templatizer["pages"]["beerAdd"] = function tmpl_pages_beerAdd() {
        return '<section class="page add-beer"><h2>Add Beer</h2><p>This form and all behavior is defined by the form view in <code>client/forms/beer.js</code>.</p><p>The same form-view is used for both editing and creating new users.</p><form role="beer-form"><fieldset role="field-container"></fieldset><div class="buttons"><button role="reset" type="submit" class="btn">Submit</button></div></form></section>';
    };

    // pages/beerEdit.jade compiled template
    templatizer["pages"]["beerEdit"] = function tmpl_pages_beerEdit() {
        return '<section class="page edit-beer"><h2>Edit Beer</h2><p>This form and all behavior is defined by the form view in <code>client/forms/beer.js</code>.</p><p>The same form-view is used for both editing and creating new users.</p><form role="beer-form"><fieldset role="field-container"></fieldset><div class="buttons"><button role="reset" type="submit" class="btn">Submit</button></div></form></section>';
    };

    // pages/beers.jade compiled template
    templatizer["pages"]["beers"] = function tmpl_pages_beers() {
        return '<section class="page pageOne"><h2>Beers Page</h2><p>Intelligently rendering collections can be a bit tricky. </p><p><a href="https://github.com/ampersandjs/ampersand-view">ampersand-view\'s</a> <code>renderCollection()</code> method makes it simple.</p><p>The only code required to manage the collection is:</p><pre><code>this.renderCollection(\n   this.collection, \n   BeerView, \n   this.getByRole(\'beer-list\')\n);</code></pre><h3>Beer container:</h3><ul role="beer-list" class="list-group"></ul><p>Try it by clicking the buttons</p><div class="buttons btn-group"><button role="reset" class="btn btn-default">.reset() </button><button role="fetch" class="btn btn-default">.fetch() </button><button role="shuffle" class="btn btn-default">.shuffle() </button><a href="/beer/add" class="btn btn-default">Add Beer</a></div><p>Events are always managed so you don\'t get any leaks.</p></section>';
    };
