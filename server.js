...
app.get('/beerApi/beers', beerApi.list);
app.get('/beerApi/beers/:id', beerApi.get);
app.delete('/beerApi/beers/:id', beerApi.delete);
app.put('/beerApi/beers/:id', beerApi.update);
app.post('/beerApi/beers', beerApi.add);
...
new Moonboots({
  moonboots: {
    jsFileName: 'beer-tracker',
    cssFileName: 'beer-tracker',
...
console.log("Beer Tracker is running at: http://localhost:" + config.http.port + " Yep. That\'s pretty awesome.");
